...
def get_action_specs() -> list[ActionSpec]:
    return [
        ...
        ActionSpec(
            "search",
            "Search the web in a new tab.",
            "Open a search results page in a new tab.",
            _add_search_arguments,
            _default_request,
        ),
        ActionSpec(
            "info",
            "Show the current page info.",
            "Return the current active tab metadata.",
            _no_arguments,
            _default_request,
        ),
        ActionSpec(
        ...
        ActionSpec(
            "back",
            "Go back in history.",
            "Navigate back in the current active tab history.",
            _no_arguments,
            _default_request,
        ),
        ActionSpec(
            ...
            "Navigate forward in the current active tab history.",
            _no_arguments,
            _default_request,
        ),
        ActionSpec(
            "tabs",
            "List visible tabs.",
            "List tabs visible to the current agent domain.",
            _no_arguments,
            _default_request,
        ),
        ActionSpec(
            "new-tab",
            "Create a new tab.",
            "Open a new blank tab or navigate to URL.",
            _add_optional_url_arguments,
            _default_request,
        ),
        ActionSpec(
            "switch-tab",
            "Switch the active tab.",
            "Switch to a visible tab by page id.",
            _add_page_id_arguments,
            _default_request,
        ),
        ActionSpec(
            "close-tab",
            "Close a tab.",
            "Close the active tab or a visible tab by page id.",
            _add_optional_page_id_arguments,
            _default_request,
        ),
        ActionSpec(
            "close",
            "Close the active tab.",
            "Close the current active tab in this agent domain.",
            _no_arguments,
            _default_request,
        ),
        ActionSpec(
        ...
        ActionSpec(
            ...
            "Fill an input-like element by ref.",
            _add_fill_arguments,
            _default_request,
        ),
        ActionSpec(
            "fill-form",
            "Fill multiple refs from JSON.",
            "Fill multiple form fields from a JSON array.",
            _add_fill_form_arguments,
            _fill_form_request,
        ),
        ActionSpec(
            "select",
            "Select an option by text.",
            "Select an option from a dropdown ref.",
            _add_select_arguments,
            _default_request,
        ),
        ActionSpec(
            "options",
            "List dropdown options.",
            "List all options from a dropdown ref.",
            _add_ref_arguments,
            _default_request,
        ),
        ActionSpec(
        ...
        ActionSpec(
            ...
            "Scroll the active page so the ref is visible.",
            _add_ref_arguments,
            _default_request,
        ),
        ActionSpec(
            "drag",
            "Drag between two refs.",
        ...
        ActionSpec(
            "upload",
            "Upload a file to an input ref.",
            "Set input files on a file input ref.",
            _add_upload_arguments,
            _default_request,
        ),
        ActionSpec(
            "type",
        ...
        ActionSpec(
            "scroll",
            "Scroll the page.",
            "Scroll the current page using mouse wheel deltas.",
            _add_scroll_arguments,
            _default_request,
        ),
        ActionSpec(
            "mouse-click",
            "Click at viewport coordinates.",
            "Click the mouse at viewport coordinates.",
            _add_mouse_click_arguments,
            _default_request,
        ),
        ActionSpec(
            "mouse-move",
            ...
            _add_mouse_move_arguments,
            _default_request,
        ),
        ActionSpec(
            "mouse-drag",
            "Drag the mouse.",
            "Drag the mouse between viewport coordinates.",
            _add_mouse_drag_arguments,
            _default_request,
        ),
        ActionSpec(
            "mouse-down",
        ...
        ActionSpec(
            "eval-on",
            "Evaluate JavaScript on a ref.",
            "Evaluate JavaScript on an element ref.",
            _add_eval_on_arguments,
            _default_request,
        ),
        ActionSpec(
            "wait",
        ...
        ActionSpec(
            ...
            "Stop capturing browser console messages.",
            _no_arguments,
            _default_request,
        ),
        ActionSpec(
            ...
            "Wait for the first matching completed network record.",
            _add_network_wait_arguments,
            _default_request,
        ),
        ActionSpec(
            "network-start",
            "Start network capture.",
            "Start capturing completed network records.",
            _no_arguments,
            _default_request,
        ),
        ActionSpec(
            "network",
            "Read network records.",
            "Read captured completed network records.",
            _add_network_arguments,
            _default_request,
        ),
        ActionSpec(
            "network-stop",
            "Stop network capture.",
            "Stop capturing completed network records.",
            _no_arguments,
            _default_request,
        ),
        ActionSpec(
            ...
            "Automatically accept or dismiss future dialogs for the active tab.",
            _add_dialog_setup_arguments,
            _default_request,
        ),
        ActionSpec(
            "dialog",
            "Configure one-time dialog handling.",
            "Handle the next dialog shown by the active tab.",
            _add_dialog_arguments,
            _default_request,
        ),
        ActionSpec(
            "dialog-remove",
            "Remove automatic dialog handling.",
            "Remove the persistent dialog handler for the active tab.",
            _no_arguments,
            _default_request,
        ),
        ActionSpec(
            "cookies",
            "List cookies.",
            "List cookies visible to the shared browser context.",
            _add_cookie_filter_arguments,
            _default_request,
        ),
        ActionSpec(
            "cookie-set",
            "Set a cookie.",
            "Set a cookie on the shared browser context.",
            _add_cookie_set_arguments,
            _default_request,
        ),
        ActionSpec(
            "cookies-clear",
            "Clear cookies.",
            "Clear cookies with optional filters.",
            _add_cookie_filter_arguments,
            _default_request,
        ),
        ActionSpec(
        ...
        ActionSpec(
            ...
            "Verify text is visible on the current page.",
            _add_verify_text_arguments,
            _default_request,
        ),
        ActionSpec(
            "verify-visible",
            "Verify role/name is visible.",
            "Verify a role/name locator is visible.",
            _add_verify_visible_arguments,
            _default_request,
        ),
        ActionSpec(
            "verify-url",
            "Verify the current URL.",
            "Verify the current URL against an expected value.",
            _add_verify_expected_arguments,
            _rename_expected_request,
        ),
        ActionSpec(
            "verify-title",
        ...
        ActionSpec(
            "verify-state",
            "Verify ref state.",
            "Verify state for an element ref.",
            _add_verify_state_arguments,
            _default_request,
        ),
        ActionSpec(
            "verify-value",
            "Verify ref value.",
            "Verify input value for an element ref.",
            _add_verify_value_arguments,
            _default_request,
        ),
        ActionSpec(
            "trace-start",
            "Start browser tracing.",
            "Start Playwright tracing on the shared browser context.",
            _add_trace_start_arguments,
            _default_request,
        ),
        ActionSpec(
            "trace-chunk",
            "Add a trace chunk.",
            "Add a named trace chunk marker to the active trace.",
            _add_trace_chunk_arguments,
            _default_request,
        ),
        ActionSpec(
            "trace-stop",
            "Stop browser tracing.",
            "Stop tracing and save a trace archive.",
            _add_optional_path_arguments,
            _default_request,
        ),
        ActionSpec(
            "video-start",
            "Start page video capture.",
            "Mark the active tab video capture session as started.",
            _add_video_start_arguments,
            _default_request,
        ),
        ActionSpec(
            "video-stop",
            "Stop page video capture.",
            "Stop the active tab video capture session and choose an output path.",
            _add_optional_path_arguments,
            _default_request,
        ),
        ActionSpec(
            "resize",
            "Resize the active viewport.",
            "Resize the active tab viewport to WIDTH x HEIGHT.",
            _add_resize_arguments,
            _default_request,
        ),
        ActionSpec(
            "stop",
            "Stop the daemon.",
            "Stop the browser daemon and the shared browser instance.",
            _no_arguments,
            _default_request,
            False,
        ),
...
def _add_optional_page_id_arguments(parser: ArgumentParser) -> None:
    parser.add_argument(
        "page_id", nargs="?", help="Optional page id. Defaults to the current active tab."
    )
...
def _add_fill_form_arguments(parser: ArgumentParser) -> None:
    ...
    parser.add_argument(
        "--submit", action="store_true", help="Press Enter after all fields are filled."
    )
...
def _add_mouse_click_arguments(parser: ArgumentParser) -> None:
    ...
    parser.add_argument(
        "--button", default="left", choices=["left", "right", "middle"], help="Mouse button."
    )
...
def _add_wait_arguments(parser: ArgumentParser) -> None:
    parser.add_argument(
        "seconds", nargs="?", type=float, help="Seconds to wait when not waiting for text."
    )
    parser.add_argument("--text", help="Visible text to wait for.")
    parser.add_argument(
        "--gone", action="store_true", help="Wait for the text to disappear instead of appear."
    )
...
def _add_console_arguments(parser: ArgumentParser) -> None:
    ...
    parser.add_argument(
        "--no-clear", action="store_true", help="Keep buffered messages after reading."
    )


def _add_network_filter_arguments(parser: ArgumentParser) -> None:
    parser.add_argument(
        "--url-contains", help="Only match records whose URL contains this substring."
    )
    ...
    parser.add_argument(
        "--mime-contains", help="Only match records whose MIME type contains this substring."
    )
    parser.add_argument(
        "--include-static", action="store_true", help="Include images, scripts, and stylesheets."
    )
...
def _add_network_arguments(parser: ArgumentParser) -> None:
    _add_network_filter_arguments(parser)
    parser.add_argument(
        "--no-clear", action="store_true", help="Keep buffered records after reading."
    )
