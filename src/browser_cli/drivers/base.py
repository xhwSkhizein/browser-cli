...
class BrowserDriver(ABC):
    ...
    async def select_option(
        self, page_id: str, locator: LocatorSpec, text: str
    ) -> dict[str, Any]: ...
    ...
    @abstractmethod
    async def check(
        self, page_id: str, locator: LocatorSpec, *, checked: bool
    ) -> dict[str, Any]: ...
    ...
    @abstractmethod
    async def upload(
        self, page_id: str, locator: LocatorSpec, file_path: str
    ) -> dict[str, Any]: ...
    ...
    async def evaluate_on(
        self, page_id: str, locator: LocatorSpec, code: str
    ) -> dict[str, Any]: ...
